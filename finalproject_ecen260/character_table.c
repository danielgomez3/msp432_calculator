...
const char character_table[][6]= {
                             ...
                             {0x7E,0x09,0x09,0x7E,0x00,0x00},  // A (now updated to look like '+'
                             ...
                             {0x7F,0x05,0x05,0x02,0x00,0x00},  /* P */
                             {0x3c, 0x42, 0X42, 0X43, 0X3d, 0x00},  /* Q not finished */
                             {0x7f, 0x09, 0x19, 0x29, 0x46, 0x00},  /* R */
                             {0x26,0x49,0x49,0x32,0x00,0x00},  /* S */
                             ...
                             {0x31,0x29,0x2D,0x25,0x23,0x00},  /* Z */
                             ...
                             {0x22,0x14,0x08,0x14,0x22,0x00}, // mult
                             {0x08,0x08,0x2A,0x08,0x08,0x00}, // divide
                             {0x3E,0x59,0x25,0x59,0x46,0x10}, // @
                             {0x10,0x20,0x1A,0x00,0x00,0x00}, // lower j
                             {0x18,0x24,0x24,0x18,0x00,0x00}, // lower o
                             {0x10,0x28,0x1E,0x20,0x00,0x00}, // lower d
                             {0x10,0x28,0x18,0x20,0x00,0x00}, // lower a
                             {0x3C,0x08,0x08,0x30,0x00,0x00}, // lower n
                             {0x2C,0x2A,0x3C,0x00,0x00,0x00}, // lower g
                             {0x36,0x36,0x00,0x00,0x00,0x00}, // ':'
                             {0x14,0x14,0x14,0x14,0x00,0x00},  // =
                             {0x00,0x0C,0x00,0x00,0x00,0x00}    // single quotemark
